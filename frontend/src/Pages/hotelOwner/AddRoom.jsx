...
const AddRoom = () => {
  ...
  return (
    ...
    <form action="">
      ...
      subtitle='Fill inn the details carefully and accurate room details , pricing and amenities , to enhance your booking experience' />
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        ...
        >
          ...
          <option value="" className="">Select Room Type</option>
          <option value="Single Bed" className="">Single Bed</option>
          <option value="Double Bed" className="">Double Bed</option>
          <option value="Luxury Room" className="">Luxury Room</option>
          <option value="Family Suite" className="">Family Suite</option>
