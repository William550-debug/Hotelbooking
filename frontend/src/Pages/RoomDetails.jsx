  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col lg:flex-row mt-6 gap-6'>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room.images.length > 1 && room.images.map((image, index)=> (
                    ...
                    src={image} key={index} alt="room_image"
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>
                At  QuickStay, we prioritize a seamless and secure experience for every guest.
                 From the moment you book, your reservation is confirmed with real-time updates and transparent pricing.
                  We offer flexible cancellation and modification options, clearly outlined during the booking process, to accommodate your changing plans. 
                  Your personal data is protected with advanced encryption, ensuring privacy and security. 
                  Our dedicated support team is available 24/7 to assist with any inquiries, ensuring a comfortable and worry-free stay from check-in to check-out.
            </p>
