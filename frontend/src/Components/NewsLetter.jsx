...
const NewsLetter = () => {
  return (
        <div className="flex flex-col items-center  max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <Title title='Stay Inspired' subtitle='Your essential guide to effortless booking is here. We bring you the latest features, tips, and deals to simplify all your plans. Get ready to experience the convenience of seamless bookings, delivered straight to your inbox'
             />
